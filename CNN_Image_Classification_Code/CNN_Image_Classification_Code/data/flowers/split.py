...
# split the data in to 8:1:1 for train, val, test
train_images = []
val_images = []
test_images = []
...
for i in range(17):
    ...
    # split the data in to 8:1:1 for train, val, test
    train_images.append(permutated_images[:8*len(permutated_images)//10])
    val_images.append(permutated_images[8*len(permutated_images)//10:9*len(permutated_images)//10])
